...
;
const metadata = {
    title: "AI Video Studio — Генерация видео с помощью AI",
    description: "Создавайте профессиональные видео из текстовых идей с помощью искусственного интеллекта. Сценарий, сториборд и экспорт в один клик."
};
